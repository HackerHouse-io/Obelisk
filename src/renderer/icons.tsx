...
export const Icon = {
  ...
  Brain: make(
    <>
      <path d="M6.4 3.3A2.2 2.2 0 004.2 5.5a2 2 0 00-1 1.7 2 2 0 00.9 1.7 2 2 0 00.7 2.4 2 2 0 002.9.3" />
      <path d="M9.6 3.3a2.2 2.2 0 012.2 2.2 2 2 0 011 1.7 2 2 0 01-.9 1.7 2 2 0 01-.7 2.4 2 2 0 01-2.9.3" />
      <path d="M8 3.1v9.6" />
    </>,
  ),
  AlertTri: make(
